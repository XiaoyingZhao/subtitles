    ...
    <div class="leftWrapper">
      ...
      <div class="vidControl">
        ...
        <div class="progressWrapper">
          <progress-bar :percent='percent' :progressPreload='progressPreload' @pbar-drag="setProgress" @pbar-seek="setProgress"></progress-bar>
        </div>
      </div>
  ...
  methods: {
    ...
    timeupdate (){
      ...
      for (let i = 0,len = coord.length; i < len; i++) {
        ...
        console.log(typeof coord[i].time);
      ...
      this.percent = this.$refs.video.currentTime / this.$refs.video.duration * 100 || 0
